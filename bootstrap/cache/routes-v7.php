...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::UWmoxnvMANmLp4wj',
          ),
          1 => NULL,
          2 => 
          array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'admin.portfolio-items.store',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/admin/(?|media/section/([^/]++)(*:39)|portfolio\\-items/([^/]++)(*:71)))/?$}sDu',
    ),
    3 => 
    array (
      39 => 
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'admin.portfolio-items.destroy',
          ),
          1 => 
          array (
            0 => 'id',
  ...
  array (
    ...
    array (
      ...
      array (
        'uses' => 'O:55:"Laravel\\SerializableClosure\\UnsignedSerializableClosure":1:{s:12:"serializable";O:46:"Laravel\\SerializableClosure\\Serializers\\Native":5:{s:3:"use";a:0:{}s:8:"function";s:825:"function () {
                    ...
                    return response(\\Illuminate\\Support\\Facades\\View::file(\'/Users/gnosis/Herd/vibehubmedia/vendor/laravel/framework/src/Illuminate/Foundation/Configuration\'.\'/../resources/health-up.blade.php\', [
                        \'exception\' => $exception,
    ...
    $sectionMedia = [];
    for ($i = 1; $i <= 6; $i++) {
        $sectionMedia[$i] = \\App\\Models\\Media::where(\'section\', $i)
...
}";s:5:"scope";s:37:"Illuminate\\Routing\\RouteFileRegistrar";s:4:"this";N;s:4:"self";s:32:"00000000000002dc0000000000000000";}}',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    $portfolioItems = \\App\\Models\\PortfolioItem::orderBy(\'display_order\')->get();
    ...
    array (
      ...
      'uri' => 'admin/media/section/{section}',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    'admin.portfolio-items.store' => 
    array (
      'methods' => 
      array (
        0 => 'POST',
      ),
      'uri' => 'admin/portfolio-items',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\AdminController@storePortfolioItem',
        'controller' => 'App\\Http\\Controllers\\AdminController@storePortfolioItem',
        'as' => 'admin.portfolio-items.store',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
    ...
    'admin.portfolio-items.destroy' => 
    array (
      'methods' => 
      array (
        0 => 'DELETE',
      ),
      'uri' => 'admin/portfolio-items/{id}',
      'action' => 
      array (
        'middleware' => 
        array (
        ...
        'uses' => 'App\\Http\\Controllers\\AdminController@destroyPortfolioItem',
        'controller' => 'App\\Http\\Controllers\\AdminController@destroyPortfolioItem',
        'as' => 'admin.portfolio-items.destroy',
        'namespace' => NULL,
        'prefix' => '/admin',
        'where' => 
        array (
