    ...
    <nav x-data="{ open: false }" class="bg-white shadow-md sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex-shrink-0">
                    <a href="<?php echo e(route('home')); ?>" class="text-2xl font-bold text-gray-900">Vibe Hub Media</a>
                </div>
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-8">
                        ...
                        <a href="<?php echo e(route('contact')); ?>" class="text-gray-700 hover:text-gray-900 px-3 py-2 text-sm font-medium transition">Contact</a>
        ...
        <div x-show="open" x-cloak class="md:hidden">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Contact</a>
                    ...
                    <div class="group relative overflow-hidden rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                        <?php if($isVideo): ?>
                            <div class="relative w-full" style="padding-bottom: 125%;">
                                ...
                                <img src="<?php echo e($item['src']); ?>" alt="<?php echo e($altText); ?>" class="absolute top-0 left-0 w-full h-full object-cover">
                            </div>
                        <?php else: ?>
                            <div class="relative w-full overflow-hidden" style="padding-bottom: 125%;">
                                <img src="<?php echo e($imageUrl); ?>" alt="<?php echo e($altText); ?>" class="absolute top-0 left-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
                            </div>
                        <?php endif; ?>
    ...
    <footer class="bg-gray-900 text-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
                <p>&copy; <?php echo e(date('Y')); ?> Vibe Hub Media. All rights reserved.</p>
            </div>
        </div>
    </footer>
</body>
...
<?php /**PATH /Users/gnosis/Herd/vibehubmedia/resources/views/index-new.blade.php ENDPATH**/ ?>